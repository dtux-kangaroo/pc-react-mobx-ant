...
const serverConfig = require('../build/server.js');
...
const DEFAULT_PORT = parseInt(process.env.PORT, 10) || serverConfig.port;
...
choosePort(HOST, DEFAULT_PORT)
  .then(port => {
    ...
    // Load proxy config
    const proxySetting = require('../build/server.js').proxy;
